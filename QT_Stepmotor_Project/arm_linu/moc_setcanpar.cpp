...
**
** Created: Mon Apr 18 16:03:27 2016
...
void SetCANPar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData SetCANPar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SetCANPar::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SetCANPar,
      qt_meta_data_SetCANPar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SetCANPar::getStaticMetaObject() { return staticMetaObject; }
