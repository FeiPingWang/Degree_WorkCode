...
**
** Created: Mon Apr 18 16:02:57 2016
...
public:
    ...
    void setupUi(QMainWindow *StepMotor)
    {
        ...
        pB_Can_Set->setGeometry(QRect(60, 40, 131, 51));
